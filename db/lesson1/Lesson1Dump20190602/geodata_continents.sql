...
CREATE TABLE `continents` (
  `idcontinents` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `continents` VALUES (1,'Евразия'),(2,'Северная Америка'),(3,'Южная Америка'),(4,'Африка'),(5,'Австралия'),(6,'Антарктида');
